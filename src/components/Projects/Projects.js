    ...
    <div className="my-5 mx-5 text-black">
      ...
      <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {projects.map((project) => (
          <div className="card  bg-base-100 shadow-xl hover:shadow-2xl hover:shadow-red-800">
            <figure>
            ...
            <div className="card-body">
              ...
              <div className="card-actions">
                <a href={project.website} className="btn btn-primary w-full">
                  Visit {project.name}
                </a>
                <a href={project.clientgit} className="btn btn-primary w-full">
                  <svg
                ...
                <button
                  onClick={() => navigateToUpdate(project.id)}
                  className="btn btn-primary w-full"
                >
                  Show more
                </button>
                {/* <Link to="/projectdescription" className="btn btn-secondary">Show more</Link> */}
              </div>
            </div>
          </div>
        ))}

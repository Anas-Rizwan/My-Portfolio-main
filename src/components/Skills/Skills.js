...
const Portfolio = () => {
  ...
  const others = ["DaisyUI", "React Reveal", "Stripe"];
  ...
  return (
    <div className="mt-5 text-black">
      ...
      <div className="collapse rounded-lg my-5 mx-3  shadow-lg hover:shadow-teal-200">
        <input type="checkbox" className="peer" />
        <div className="collapse-title bg-gradient-to-r from-violet-900 to-white  text-secondary-content peer-checked:bg-gradient-to-r from-cyan-500 to-blue-500 peer-checked:text-secondary-content  lg:text-xl font-bold">
